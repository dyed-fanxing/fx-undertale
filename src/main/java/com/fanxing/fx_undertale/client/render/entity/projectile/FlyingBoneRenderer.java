package com.fanxing.fx_undertale.client.render.entity.projectile;
 ...
 */
public class FlyingBoneRenderer extends GeoEntityRenderer<FlyingBone> {

    public FlyingBoneRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new FlyingBoneModel());
    }

    @Override
    public void scaleModelForRender(float widthScale, float heightScale, PoseStack poseStack, FlyingBone animatable, BakedGeoModel model, boolean isReRender, float partialTick, int packedLight, int packedOverlay) {
