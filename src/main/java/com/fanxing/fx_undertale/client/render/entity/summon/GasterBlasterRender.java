...
public class GasterBlasterRender extends GeoEntityRenderer<GasterBlaster> {
    ...
    @Override
    public void renderFinal(PoseStack poseStack, GasterBlaster animatable, BakedGeoModel model, MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay, int colour) {
