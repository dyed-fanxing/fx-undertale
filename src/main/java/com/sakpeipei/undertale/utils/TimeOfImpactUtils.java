...
public class TimeOfImpactUtils {
    ...
    /**
     * 使用时间参数法检测AABB在移动中与方块/流体的碰撞（支持ClipContext）
     */
    @Nullable
    public static BlockHitResult getBlockHitResult(Level level, AABB box, Vec3 velocity,ClipContext context) {
        ...
        BlockHitResult earliestHit = null;
        ...
        for (BlockPos pos : BlockPos.betweenClosed(
            ...
            // 获取方块和流体的碰撞形状
            VoxelShape blockShape = context.getBlockShape(blockState, level, pos);
            VoxelShape fluidShape = context.getFluidShape(fluidState, level, pos);
            // 检测方块碰撞
     ...
     * 计算碰撞法线
     */
    private static Direction calculateCollisionNormal(
        AABB movingBox, AABB staticBox, Vec3 velocity, double collisionTime) {
