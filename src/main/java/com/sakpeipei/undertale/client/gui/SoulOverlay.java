...
public class SoulOverlay {
    ...
    public static final ResourceLocation[] RED = new ResourceLocation[]{
            ResourceLocation.fromNamespaceAndPath(Undertale.MOD_ID, "hud/soul_outline_red"),
            ResourceLocation.fromNamespaceAndPath(Undertale.MOD_ID, "hud/soul_fill_red")
    };
    public static final ResourceLocation[] BLUE = new ResourceLocation[]{
            ResourceLocation.fromNamespaceAndPath(Undertale.MOD_ID, "hud/soul_outline_blue"),
            ResourceLocation.fromNamespaceAndPath(Undertale.MOD_ID, "hud/soul_fill_blue")
    };
