...
public class Config {
    ...
    public static class Common {
        ...
        public Common(ModConfigSpec.Builder builder) {
            ...
            builder.translation("config.undertale.general");
            this.segments = builder
                    .translation("config.undertale.general.segments")
                    .defineInRange("segments", 8, 4, 128);
            builder.pop();
        }
    ...
    public static class Server {
        ...
        public Server(ModConfigSpec.Builder builder) {
            ...
            expPerLv = builder
                    .comment("每级所需经验基数")
                    .translation("undertale.configuration.general.expPerLv")  // 修改
                    .defineInRange("expPerLevel", 100, 1, 10000);
            expCurveExponent = builder
                    .comment("经验曲线指数（1.0=线性，1.5=平缓曲线）")
                    .translation("undertale.configuration.general.expCurveExponent")  // 修改
                    .defineInRange("expCurveExponent", 1.5, 1.0, 3.0);
            maxLv = builder
                    .comment("最大LV")
                    .translation("undertale.configuration.general.maxLv")  // 修改
                    .defineInRange("expPerLevel", 0, 0, 20);
            builder.pop();

            // ----- 实体经验列表 -----
            builder.push("entity_exp");
            builder.translation("undertale.configuration.entity_exp");  // 修改
            entityExpList = builder
                    .comment("实体经验配置列表，格式: \"实体ID,经验值,击杀上限\" (limit=-1表示无限)")
                    .translation("undertale.configuration.entity_exp.entityExp")  // 修改
            ...
            builder.translation("undertale.configuration.special_kills");  // 修改
            namedKillExp = builder
                    .comment("杀死命名且存活足够天数的生物获得的额外经验")
                    .translation("undertale.configuration.special_kills.namedKillExp")  // 修改
                    .defineInRange("namedKillExp", 100, 0, 10000);
            namedKillDays = builder
                    .comment("命名生物所需最小存活天数")
                    .translation("undertale.configuration.special_kills.namedKillDays")  // 修改
                    .defineInRange("namedKillDays", 30, 1, 365);
            tamedKillExp = builder
                    .comment("杀死驯服且存活足够天数的生物获得的额外经验")
                    .translation("undertale.configuration.special_kills.tamedKillExp")  // 修改
                    .defineInRange("tamedKillExp", 300, 0, 10000);
            tamedKillDays = builder
                    .comment("驯服生物所需最小存活天数")
                    .translation("undertale.configuration.special_kills.tamedKillDays")  // 修改
                    .defineInRange("tamedKillDays", 30, 1, 365);
            builder.pop();

            // ----- 属性点设置 -----
            builder.push("attributes");
            builder.translation("undertale.configuration.attributes");  // 修改
            pointsPerLevel = builder
                    .comment("每升一级获得的属性点")
                    .translation("undertale.configuration.attributes.pointsPerLevel")  // 修改
                    .defineInRange("pointsPerLevel", 2, 1, 100);
            strengthPerPoint = builder
                    .comment("每点力量增加的伤害百分比（1=1%）")
                    .translation("undertale.configuration.attributes.strengthPerPoint")  // 修改
                    .defineInRange("strengthPerPoint", 1, 0, 100);
            toughnessArmorPerPoint = builder
                    .comment("每点坚韧增加的护甲值")
                    .translation("undertale.configuration.attributes.toughnessArmorPerPoint")  // 修改
                    .defineInRange("toughnessArmorPerPoint", 0.5, 0.0, 10.0);
            toughnessToughnessPerPoint = builder
                    .comment("每点坚韧增加的护甲韧性")
                    .translation("undertale.configuration.attributes.toughnessToughnessPerPoint")  // 修改
                    .defineInRange("toughnessToughnessPerPoint", 0.25, 0.0, 10.0);
            healthPerPoint = builder
                    .comment("每点生命增加的最大生命值")
                    .translation("undertale.configuration.attributes.healthPerPoint")  // 修改
                    .defineInRange("healthPerPoint", 1, 0, 100);
            builder.pop();

            // ----- 角色实体ID -----
            builder.push("character_entities");
            builder.translation("undertale.configuration.character_entities");  // 修改
            torielEntityId = builder
                    .comment("Toriel 实体ID")
                    .translation("undertale.configuration.character_entities.torielEntityId")  // 修改
                    .define("torielEntityId", "ut:toriel");
            papyrusEntityId = builder
                    .comment("Papyrus 实体ID")
                    .translation("undertale.configuration.character_entities.papyrusEntityId")  // 修改
                    .define("papyrusEntityId", "ut:papyrus");
            undyneEntityId = builder
                    .comment("Undyne 实体ID")
                    .translation("undertale.configuration.character_entities.undyneEntityId")  // 修改
                    .define("undyneEntityId", "ut:undyne");
            alphysEntityId = builder
                    .comment("Alphys 实体ID")
                    .translation("undertale.configuration.character_entities.alphysEntityId")  // 修改
                    .define("alphysEntityId", "ut:alphys");
            mettatonEntityId = builder
                    .comment("Mettaton 实体ID")
                    .translation("undertale.configuration.character_entities.mettatonEntityId")  // 修改
                    .define("mettatonEntityId", "ut:mettaton");
            sansEntityId = builder
                    .comment("Sans 实体ID")
                    .translation("undertale.configuration.character_entities.sansEntityId")  // 修改
                    .define("sansEntityId", "ut:sans");
            asgoreEntityId = builder
                    .comment("Asgore 实体ID")
                    .translation("undertale.configuration.character_entities.asgoreEntityId")  // 修改
            ...
            builder.translation("undertale.configuration.chara_hidden");
            charaMaxHpPercent = builder
                    .comment("每次攻击削减目标最大生命值百分比（真实伤害）")
                    .translation("undertale.configuration.chara_hidden.charaMaxHpPercent")  // 修改
                    .defineInRange("charaMaxHpPercent", 0.01, 0.0, 0.1);
            charaRemoveBuffs = builder
                    .comment("攻击是否移除目标所有正面效果")
                    .translation("undertale.configuration.chara_hidden.charaRemoveBuffs")  // 修改
    ...
    public static class TorielConfig {
        ...
        private TorielConfig(ModConfigSpec.Builder builder) {
            builder.push("toriel");
            builder.translation("undertale.configuration.toriel");
            builder.comment("");
            damageThreshold = builder
                    .comment("目标生命低于此比例时触发")
                    .translation("undertale.configuration.toriel.damageThreshold")  // 统一前缀
                    .defineInRange("damageThreshold", 0.3, 0.0, 1.0);
            damageStep = builder
                    .comment("每级增伤增加比例")
                    .translation("undertale.configuration.toriel.damageStep")
    ...
    public static class PapyrusConfig {
        ...
        private PapyrusConfig(ModConfigSpec.Builder builder) {
            ...
            critDamageStep = builder
                    .comment("每级暴击伤害增加量")
                    .translation("undertale.configuration.papyrus.critDamageStep")
    ...
    public static class UndyneConfig {
        ...
        private UndyneConfig(ModConfigSpec.Builder builder) {
            ...
            attackSpeedStep = builder
                    .comment("每级攻速增加比例")
                    .translation("undertale.configuration.undyne.attackSpeedStep")
    ...
    public static class AlphysConfig {
        ...
        private AlphysConfig(ModConfigSpec.Builder builder) {
            ...
            damageReductionStep = builder
                    .comment("每级减伤增加比例")
                    .translation("undertale.configuration.alphys.damageReductionStep")
                    .defineInRange("damageReductionStep", 0.05, 0.0, 1.0);
            durationStep = builder
                    .comment("每级增加秒数")
                    .translation("undertale.configuration.alphys.durationStep")
    ...
    public static class MettatonConfig {
        ...
        private MettatonConfig(ModConfigSpec.Builder builder) {
            ...
            damagePerEnemyStep = builder
                    .comment("每级增伤增加比例")
                    .translation("undertale.configuration.mettaton.damagePerEnemyStep")
                    .defineInRange("damagePerEnemyStep", 0.01, 0.0, 1.0);
            rangeStep = builder
                    .comment("每级增加范围（格）")
                    .translation("undertale.configuration.mettaton.rangeStep")
    ...
    public static class SansConfig {
        ...
        private SansConfig(ModConfigSpec.Builder builder) {
            ...
            iFrameReductionStep = builder
                    .comment("每级无敌帧减少比例增加")
                    .translation("undertale.configuration.sans.frameReductionStep")
    ...
    public static class AsgoreConfig {
        ...
        private AsgoreConfig(ModConfigSpec.Builder builder) {
            ...
            armorPierceStep = builder
                    .comment("每级无视护甲增加比例")
                    .translation("undertale.configuration.asgore.armorPierceStep")
                    .defineInRange("armorPierceStep", 0.05, 0.0, 1.0);
            shieldBreakStep = builder
                    .comment("每级破盾概率增加")
                    .translation("undertale.configuration.asgore.shieldBreakStep")
