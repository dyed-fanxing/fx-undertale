...
public class EntityTypeRegistry {
    ...
    public static final DeferredHolder<EntityType<?>,EntityType<Sans>> SANS =
            ENTITY_TYPES.register("sans",
                    () -> EntityType.Builder.of(Sans::new, MobCategory.MONSTER)
                            .sized(0.5f, 1.8f)  // 碰撞箱
                            .clientTrackingRange(4)  // 客户端同步范围，以区块为单位
                            .build(ResourceLocation.fromNamespaceAndPath(Undertale.MODID,"sans").toString())
            );
}
