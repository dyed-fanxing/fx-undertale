...
public abstract class AbstractAnimType<T> implements AnimType<T> {
    ...
    protected AbstractAnimType(byte id, int duration, boolean triggerAnim, int cd, T action) {
        this.id = id;
    ...
    public AbstractAnimType(byte id, int duration, int cd, T action) {
        this(id, duration, false, cd, action);
    }


    protected AbstractAnimType(byte id, int duration, boolean triggerAnim, int cd) {
        this.id = id;
        this.duration = duration;
        this.triggerAnim = triggerAnim;
        this.cd = cd;
    ...
    protected AbstractAnimType(byte id, int duration, int cd) {
